...
txt_end = "ваш результат"

my_instruct = '''Если вы не хотите узнать насколько хорошо работает ваше сердце, то прямо сейчас закройте это приложение.
Если же это не так, то уже через 3 минуты вы будете знать стоит ли вам больше заниматься спортом, а может даже и пойти к врачу.

Для начала напишите ваше имя, это поможет нам узнать с каким сердцем вы родились.'''